...
<div id="pagina" style="width:760px; margin:0 auto;">
	<div id="conteudo" style="padding:5px;padding-top:160px;">	
		<form id="formFileupload" style="padding-left:150px" action="<c:url value='upload/file'/>" method="POST" enctype="multipart/form-data">
			...
			<i class="icon-white icon-upload"></i>Enviar arquivo</button><br/>
